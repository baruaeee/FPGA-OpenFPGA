...
# Generated on: Wed Oct 23 02:58:16 CEST 2024 (Wed Oct 23 00:58:16 UTC 2024)
...
set logfile fv/MULTI_MODE_DFFNRQ/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/MULTI_MODE_DFFNRQ -revised fv_map
...
read_library -liberty -both \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/sky130_fd_sc_hd__tt_025C_1v80.lib
...
elaborate_design -golden -root {MULTI_MODE_DFFNRQ} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/MULTI_MODE_DFFNRQ/fv_map.v.gz
elaborate_design -revised -root {MULTI_MODE_DFFNRQ}
...
#add_name_alias fv/MULTI_MODE_DFFNRQ/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.MULTI_MODE_DFFNRQ.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.MULTI_MODE_DFFNRQ.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.MULTI_MODE_DFFNRQ.rtl.fv_map.rpt
