...
# Generated on: Wed Oct 23 02:58:18 CEST 2024 (Wed Oct 23 00:58:18 UTC 2024)
...
set logfile fv/DFFSR/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/DFFSR -revised fv_map
...
elaborate_design -golden -root {DFFSR} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/DFFSR/fv_map.v.gz
elaborate_design -revised -root {DFFSR}
...
#add_name_alias fv/DFFSR/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.DFFSR.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.DFFSR.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.DFFSR.rtl.fv_map.rpt
