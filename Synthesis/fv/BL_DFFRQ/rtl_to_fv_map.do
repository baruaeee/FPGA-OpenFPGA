...
set logfile fv/BL_DFFRQ/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/BL_DFFRQ -revised fv_map
...
elaborate_design -golden -root {BL_DFFRQ} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/BL_DFFRQ/fv_map.v.gz
elaborate_design -revised -root {BL_DFFRQ}
...
#add_name_alias fv/BL_DFFRQ/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.BL_DFFRQ.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.BL_DFFRQ.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.BL_DFFRQ.rtl.fv_map.rpt
