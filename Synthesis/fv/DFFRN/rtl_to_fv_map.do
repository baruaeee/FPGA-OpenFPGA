...
# Generated on: Wed Oct 23 02:58:20 CEST 2024 (Wed Oct 23 00:58:20 UTC 2024)
...
set logfile fv/DFFRN/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/DFFRN -revised fv_map
...
elaborate_design -golden -root {DFFRN} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/DFFRN/fv_map.v.gz
elaborate_design -revised -root {DFFRN}
...
#add_name_alias fv/DFFRN/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.DFFRN.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.DFFRN.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.DFFRN.rtl.fv_map.rpt
