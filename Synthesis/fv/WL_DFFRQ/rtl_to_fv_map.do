...
set logfile fv/WL_DFFRQ/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/WL_DFFRQ -revised fv_map
...
elaborate_design -golden -root {WL_DFFRQ} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/WL_DFFRQ/fv_map.v.gz
elaborate_design -revised -root {WL_DFFRQ}
...
#add_name_alias fv/WL_DFFRQ/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.WL_DFFRQ.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.WL_DFFRQ.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.WL_DFFRQ.rtl.fv_map.rpt
