...
set logfile fv/DFF/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
set_system_mode lec
write_compared_points noneq.compared_points.DFF.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.DFF.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.DFF.rtl.fv_map.rpt
