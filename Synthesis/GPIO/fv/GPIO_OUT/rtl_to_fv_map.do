...
# Generated on: Mon Nov 11 20:55:20 CET 2024 (Mon Nov 11 19:55:20 UTC 2024)
...
set logfile fv/GPIO_OUT/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/GPIO_OUT -revised fv_map
...
read_library -liberty -both \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/GPIO/LIB/sky130_fd_io__top_gpiov2_tt_tt_025C_1v80_3v30.lib \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/GPIO/LIB/sky130_osu_sc_18T_hs_TT_1P8_25C.ccs.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/GPIO/gpio_outpad_sky130.v
elaborate_design -golden -root {GPIO_OUT} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/GPIO_OUT/fv_map.v.gz
elaborate_design -revised -root {GPIO_OUT}
...
set_system_mode lec
write_compared_points noneq.compared_points.GPIO_OUT.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.GPIO_OUT.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.GPIO_OUT.rtl.fv_map.rpt
