...
# Generated on: Thu Nov 21 04:01:32 CET 2024 (Thu Nov 21 03:01:32 UTC 2024)
...
set logfile fv/GPIO_IN/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/GPIO_IN -revised fv_map
...
read_library -liberty -both \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/GPIO/LIB/sky130_scl_9T_0_0_5/sky130_ff_1.98_0_nldm.lib \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/GPIO/LIB/sky130_scl_9T_0_0_5/sky130_ss_1.62_125_nldm.lib \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/GPIO/LIB/sky130_scl_9T_0_0_5/sky130_tt_1.8_25_nldm.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k gpio_inpad_sky130.v
elaborate_design -golden -root {GPIO_IN} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/GPIO_IN/fv_map.v.gz
elaborate_design -revised -root {GPIO_IN}
...
add_black_box sky130_fd_io__top_gpio_ovtv2 -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.GPIO_IN.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.GPIO_IN.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.GPIO_IN.rtl.fv_map.rpt
