...
# Libraries
################################################################################
::legacy::set_attribute library {/home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/Fabric/auto_3x3_osu/LIB/sky130_osu_sc_18T_hs_TT_1P8_25C.ccs.lib /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/Fabric/auto_3x3_osu/LIB/sky130_fd_io__top_gpiov2_tt_tt_025C_1v80_3v30.lib} /
...
if {$_cell_area_ != "222600"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 222600,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
