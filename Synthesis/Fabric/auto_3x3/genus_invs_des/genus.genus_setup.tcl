...
# Libraries
################################################################################
::legacy::set_attribute library {/home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/Fabric/auto_3x3/sky130_fd_sc_hd__tt_025C_1v80.lib} /
...
if {$_cell_area_ != "171499"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 171499,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
