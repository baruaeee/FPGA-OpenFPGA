...
# Generated on: Fri Nov 01 21:09:16 CET 2024 (Fri Nov 01 20:09:16 UTC 2024)
...
set logfile fv/const0/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/const0 -revised fv_map
...
read_library -liberty -both \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/Fabric/auto_3x3/sky130_fd_sc_hd__tt_025C_1v80.lib \
    /home/cae1/Desktop/FPGA-OpenFPGA/Synthesis/Fabric/auto_3x3/sky130_fd_sc_hd__tt_025C_1v80.lib
...
elaborate_design -golden -root {const0} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/const0/fv_map.v.gz
elaborate_design -revised -root {const0}
...
set_system_mode lec
write_compared_points noneq.compared_points.const0.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.const0.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.const0.rtl.fv_map.rpt
