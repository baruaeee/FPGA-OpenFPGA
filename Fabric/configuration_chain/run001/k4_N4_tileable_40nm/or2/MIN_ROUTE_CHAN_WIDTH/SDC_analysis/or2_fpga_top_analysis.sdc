...
# Create clock                                    
##################################################
create_clock clk[0] -period 9.772329612e-10 -waveform {0 4.886164806e-10}

##################################################
# Create input and output delays for used I/Os    
##################################################
set_input_delay -clock clk[0] -max 9.772329612e-10 gfpga_pad_GPIO_PAD[31]
set_input_delay -clock clk[0] -max 9.772329612e-10 gfpga_pad_GPIO_PAD[14]
set_output_delay -clock clk[0] -max 9.772329612e-10 gfpga_pad_GPIO_PAD[20]
