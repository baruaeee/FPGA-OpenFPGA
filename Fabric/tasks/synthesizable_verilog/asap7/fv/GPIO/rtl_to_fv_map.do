...
# Generated on: Fri Nov 08 00:54:46 CET 2024 (Thu Nov 07 23:54:46 UTC 2024)
...
set logfile fv/GPIO/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/GPIO -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86"
set CDN_SYNTH_ROOT      "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86"
set env(CW_DIR) "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware"
set CW_DIR      "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/eda/cadence/2023-24/RHELx86/DDIEXPORT_22.33.000/GENUS221/tools.lnx86/lib/chipware/sim"
}
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k gpio.v
elaborate_design -golden -root {GPIO} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/GPIO/fv_map.v.gz
elaborate_design -revised -root {GPIO}
...
set_system_mode lec
write_compared_points noneq.compared_points.GPIO.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.GPIO.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.GPIO.rtl.fv_map.rpt
