...
# Generated on: Thu Nov 07 03:46:54 CET 2024 (Thu Nov 07 02:46:54 UTC 2024)
...
set logfile fv/MUX2/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/MUX2 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k mux2.v
elaborate_design -golden -root {MUX2} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/MUX2/fv_map.v.gz
elaborate_design -revised -root {MUX2}
...
set_system_mode lec
write_compared_points noneq.compared_points.MUX2.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.MUX2.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.MUX2.rtl.fv_map.rpt
