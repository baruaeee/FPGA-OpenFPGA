...
(iopad
  (topleft
    ...
    (endspace gap=20)
    (inst name="Corner_TL1" cell=sky130_fd_io__corner_bus_overlay offset=0 orientation=R90 space=20 place_status = fixed)
  )
  ...
  (topright
    ...
    (locals ring_number=1)
    (endspace gap=20)
    (inst name="Corner_TR1" cell=sky130_fd_io__corner_bus_overlay offset=0 orientation=R0 space=20 place_status = fixed)
  )
  ...
  (left
    (locals ring_number=2)
    (inst name="pad_pwr1" place_status = fixed orientation=R90 skip=37)
    (inst name="grid_io_left_0__1_/logical_tile_io_mode_io__0/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=R90 skip=37)
    (inst name="grid_io_left_0__1_/logical_tile_io_mode_io__1/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=R90 skip=37)
    (inst name="grid_io_left_0__1_/logical_tile_io_mode_io__2/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=R90 skip=37)
  ...
  (top
    (locals ring_number=2)
    (inst name="pad_gnd1" place_status = fixed orientation=R0 skip=33.733)
    (inst name="grid_io_top_1__2_/logical_tile_io_mode_io__2/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=R0 skip=33.733)
    (inst name="grid_io_top_1__2_/logical_tile_io_mode_io__3/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=R0 skip=33.733)
    (inst name="grid_io_top_1__2_/logical_tile_io_mode_io__4/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=R0 skip=33.733)
  ...
  (right
    ...
    (inst name="grid_io_right_2__1_/logical_tile_io_mode_io__4/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=MX90 skip=37)
    (inst name="grid_io_right_2__1_/logical_tile_io_mode_io__5/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=MX90 skip=37)
    (inst name="grid_io_right_2__1_/logical_tile_io_mode_io__6/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=MX90 skip=37)
 ...
 (bottom
    ...
    (inst name="grid_io_bottom_1__0_/logical_tile_io_mode_io__7/logical_tile_io_mode_physical__iopad_0/GPIO_0_/gpio" place_status = fixed orientation=MX skip=46.7328)
#### PG pins start
    (inst name="pad_gnd2" place_status = fixed orientation=MX skip=46.7328)
    (inst name="pad_pwr3" place_status = fixed orientation=MX skip=46.7328)
#### PG pins end
