...
//#define ETH_BUFFER_BASE (volatile unsigned long xdata*) 0x8000L
#define ETH_BUFFER_BASE (volatile unsigned long xdata*) 0xE000L
//#define ETH_BASE 0xA000L
#define ETH_BASE 0xD000L

#define MODER         (volatile unsigned long xdata*)(ETH_BASE)
#define INT_SOURCE    (volatile unsigned char xdata*)(ETH_BASE+4+3)
#define INT_MASK      (volatile unsigned char xdata*)(ETH_BASE+8+3)
#define IPGT          (volatile unsigned char xdata*)(ETH_BASE+12+3)
#define IPGR1         (volatile unsigned char xdata*)(ETH_BASE+16+3)
#define IPGR2         (volatile unsigned char xdata*)(ETH_BASE+20+3)
#define PACKETLEN     (volatile unsigned long xdata*)(ETH_BASE+24)
#define COLLCONF      (volatile unsigned long xdata*)(ETH_BASE+28)
#define TX_BD_NUM     (volatile unsigned char xdata*)(ETH_BASE+32+3)
#define CTRLMODER     (volatile unsigned char xdata*)(ETH_BASE+36+3)
#define MIIMODER      (volatile unsigned short xdata*)(ETH_BASE+40+2)
#define MIICOMMAND    (volatile unsigned char xdata*)(ETH_BASE+44+3)
#define MIIADDRESS    (volatile unsigned short xdata*)(ETH_BASE+48+2)
#define MII_TX_DATA   (volatile unsigned short xdata*)(ETH_BASE+52+2)
#define MII_RX_DATA   (volatile unsigned short xdata*)(ETH_BASE+56+2)
#define MII_STATUS    (volatile unsigned char xdata*)(ETH_BASE+60+3)
#define MAC_ADDR1     (volatile unsigned long xdata*)(ETH_BASE+64)
#define MAC_ADDR2     (volatile unsigned long xdata*)(ETH_BASE+68)
#define ETH_HASH0_ADR (volatile unsigned long xdata*)(ETH_BASE+72)
#define ETH_HASH1_ADR (volatile unsigned long xdata*)(ETH_BASE+76)
#define ETH_TXCTRL    (volatile unsigned long xdata*)(ETH_BASE+80)
...
#define OETH_BD_BASE            (ETH_BASE + 0x400)
...
/*
#define Read_Frame_word() (*((unsigned int*)pRxPtr)); \
                                 pRxPtr+=2 
...
//#define Write_Frame_word(w) ((*(unsigned int*)pTxPtr++)=w) 
#define Write_Frame_word(p,w) (*((unsigned int*)p)=w); \
                                 p+=2 

#define Write_Frame_long(p,w) (*((unsigned long*)p)=w); \
                                 p+=4 
