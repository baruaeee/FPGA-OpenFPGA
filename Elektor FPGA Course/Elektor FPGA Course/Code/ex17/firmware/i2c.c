...
#define SDA_HIGH {P0_0=1; I2C_delay();}
#define SCL_HIGH {P0_1=1; while (!P0_1);I2C_delay();}
//#define SCL_HIGH {P0_7=1; while (!P0_1);I2C_delay();}

#define SDA_LOW  {P0_0=0; I2C_delay();}
#define SCL_LOW  {P0_1=0; I2C_delay();}
...
//    if ((P0 & 0x40)==0x40) dat=(dat<<1)+1; else dat=dat<<1;
    ...
    if (P0_0) dat=(dat<<1)+1; else dat=dat<<1;
//    if (P0_6) dat=(dat<<1)+1; else dat=dat<<1;
    SCL_LOW
  }
  if (ack) 
